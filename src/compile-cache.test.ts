...
describe("enableCompileCache", () => {
  it("enables the cache and never throws", () => {
  ...
  it("persists compiled modules across runs in a fresh process", () => {
  ...
  it("lets NODE_COMPILE_CACHE win over the derived directory in a fresh process", () => {
