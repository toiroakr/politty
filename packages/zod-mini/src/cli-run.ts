/**
 * The real CLI graph behind the bin shim. The zod/mini adapter must be
 * registered before `@politty/core/cli-main` runs the politty CLI (whose
 * subcommands can dynamically load user command modules with zod/mini
...
await runPolittyCli("@politty/zod-mini");
