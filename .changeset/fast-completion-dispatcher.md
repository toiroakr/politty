...
- For published CLIs, generate and ship a bundled worker artifact such as `mycli completion zsh --static --worker > dist/completion/zsh-worker.zsh` to avoid first-TAB worker generation.
